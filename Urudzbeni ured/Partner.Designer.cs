...
namespace Urudzbeni_ured.PartnerTableAdapters {
    ...
    public partial class partnerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `PA_ID`, `PA_NAZIV` FROM `partner`";
        ...
        public virtual Partner.partnerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Partner.partnerDataTable dataTable = new Partner.partnerDataTable();
        ...
        public virtual int Delete(int Original_PA_ID, string Original_PA_NAZIV) {
            ...
            if ((Original_PA_NAZIV == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_PA_NAZIV));
            }
        ...
        public virtual int Update(string PA_NAZIV, int Original_PA_ID, string Original_PA_NAZIV) {
            if ((PA_NAZIV == null)) {
                throw new global::System.ArgumentNullException("PA_NAZIV");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(PA_NAZIV));
            }
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_PA_ID));
            if ((Original_PA_NAZIV == null)) {
                throw new global::System.ArgumentNullException("Original_PA_NAZIV");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_PA_NAZIV));
            }
